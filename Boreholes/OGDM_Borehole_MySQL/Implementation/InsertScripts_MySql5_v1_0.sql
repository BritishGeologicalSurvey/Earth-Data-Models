...
Insert into PROJECT
   (PROJECT_ID, DESCRIPTION, PROJECT_TYPE_CODE, START_DATE, FINISH_DATE, 
    ...
    PROJECT_NAME)
 Values
   (1, 'Project A description', 'S', STR_TO_DATE('10-JAN-06','%d-%M-%y'), STR_TO_DATE('25-DEC-11','%d-%M-%y'), 
    '1', 'A', 1, 10000, 1, 
    'Project A');
...
Insert into DIC_SOURCE_MEDIUM
   (CODE, DESCRIPTION, TRANSLATION, STATUS)
 Values
   ('CORE', 'Physical borehole core', 'Borehole core', 'C');
...
Insert into BHD_INDEX
 ...
 Values
   ('SK63SW', 'BJ', 20, '.', 'Borehole A', 
    ...
    1, 1, STR_TO_DATE('01-JAN-75','%d-%M-%y'), 'D');
